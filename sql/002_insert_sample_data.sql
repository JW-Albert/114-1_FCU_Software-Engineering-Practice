...
-- 插入測試用戶資料
INSERT INTO users (username, hashed_password, mode, budget, target_calories, target_protein, target_fat)
VALUES
...
-- 插入測試餐廳資料
INSERT INTO restaurants (name, address, average_rating, price_range, food_type, vegetarian_option)
VALUES
...
-- 插入測試餐點資料
INSERT INTO menu_items (restaurant_id, name, description, price, calories, protein, carbs, fat)
VALUES
...
-- 插入測試飲食紀錄（假設今天日期）
INSERT INTO diet_logs (user_id, item_id, timestamp, portion_size)
VALUES
...
-- 插入測試評論
INSERT INTO reviews (restaurant_id, user_id, rating, comment, timestamp)
VALUES
